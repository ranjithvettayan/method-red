"""Compat shim — content moved to ``decepticon_core.types.llm``.
...
import decepticon_core.types.llm as _target

_LEGACY = "decepticon.llm.models"
_CANONICAL = "decepticon_core.types.llm"
_seen: set[str] = set()
