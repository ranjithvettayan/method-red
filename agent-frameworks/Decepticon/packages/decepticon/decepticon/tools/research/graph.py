"""Compat shim — content moved to ``decepticon_core.types.kg``.
...
import decepticon_core.types.kg as _target

_LEGACY = "decepticon.tools.research.graph"
_CANONICAL = "decepticon_core.types.kg"
_seen: set[str] = set()
