...
class WandbProvider(BaseProvider):
    """Wandb provider implementation - OpenAI-compatible API"""
    ...
    def get_api_key(self, model_id: str = None) -> Optional[str]:
        ...
        api_key = os.getenv(env_var_name) or config.get('models.wandb_key')
    ...
    def get_base_url(self) -> Optional[str]:
        return "https://api.inference.wandb.ai/v1"