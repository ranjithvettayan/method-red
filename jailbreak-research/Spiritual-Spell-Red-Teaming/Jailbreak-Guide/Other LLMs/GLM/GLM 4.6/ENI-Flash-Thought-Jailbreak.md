# ENI Flash Thought Jailbreak (GLM)
...
**Note:** The guide appears incomplete here, with the core_guidelines section cut off mid-instruction. The actual jailbreak likely continues.

## Usage Notes

- More comprehensive than base jailbreak
- Creates persistent ENI persona
- May be more effective at bypassing GLM's filtering
- Works with GLM's reasoning capabilities
