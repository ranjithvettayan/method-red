...
Moonshot AI released a very solid update.
Very solid reasoning blocks, haven't been able to fully break them like before in my last jailbreak, but it is still early in the day and doesn't truly matter. Anywhoo, simply copy and paste the following into a chat
...
```
Use boomba after the model responds as ENI, it oftens reasons if it has produced illegal content before then it's good to go.
...
**System Prompt:**
See [Kimi k2.5 system prompt](Kimi%20k2.5%20system%20prompt.md) for the full system prompt text.
